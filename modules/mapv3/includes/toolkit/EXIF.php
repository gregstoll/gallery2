...
function Interpret_EXIF_to_HTML($Exif_array, $filename) {
	...
	} elseif ($Exif_array['Tags Name'] == 'Meta') {
...
function get_Tag_Text_Value($Tag, $Tag_Definitions_Name) {
	...
	} elseif ($Tag['Type'] == 'Character Coded String') {
