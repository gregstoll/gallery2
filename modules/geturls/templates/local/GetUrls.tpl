...
<div class="gbBlock">
  ...
  <p class="gbDescription">
    ...
    <br />
    <input onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;">
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:navigator.clipboard.writeText('&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;');window.status = '[IMG]{$GetUrlsData.itemId}[/IMG] copied to your clipboard for forum posting!';" href>[IMG]</a>{/if}
  </p>
  ...
  <p class="gbDescription">
    ...
    <br />
    <input onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;">
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:navigator.clipboard.writeText('&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;');window.status = '[IMG]{$GetUrlsData.itemId}[/IMG] copied to your clipboard for forum posting!';" href>[IMG]</a>{/if}
  </p>
  {/if}
  {/if}
  ...
  <p class="gbDescription">
    ...
    <br />
    <input onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;a href=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false}&quot;&gt;&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;&lt;/a&gt;">
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:navigator.clipboard.writeText('&lt;a href=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot;&gt;&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.resizeId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;&lt;/a&gt;');window.status = '[R2F]{$GetUrlsData.resizeId}[/R2F] copied to your clipboard for forum posting!';" href>[R2F]</a>{/if}
  </p>
  {/if}
  ...
  <p class="gbDescription">
    ...
    <br />
    <input onclick="this.focus(); this.select();" name="forum" type="text" readonly="true" size="{$width}" value="&lt;a href=&quot;{g->url arg1="view=core.ShowItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false}&quot;&gt;&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.thumbId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;&lt;/a&gt;">
    {if $GetUrlsData.showIeLinks} <a onclick="javascript:navigator.clipboard.writeText('&lt;a href=&quot;{g->url arg1="view=core.ShowItem" arg2="itemId=`$GetUrlsData.itemId`" forceFullUrl=true forceSessionId=false htmlEntities=false}&quot;&gt;&lt;img src=&quot;{g->url arg1="view=core.DownloadItem" arg2="itemId=`$GetUrlsData.thumbId`" forceFullUrl=true forceSessionId=false}&quot; alt=&quot;{$itemTitle}&quot;  title=&quot;{$itemTitle}&quot;&gt;&lt;/a&gt;');window.status = '[TMB]{$GetUrlsData.thumbId}[/TMB] copied to your clipboard for forum posting!';" href>[TMB]</a>{/if}
  </p>
  {/if}
</div>
{/if}
